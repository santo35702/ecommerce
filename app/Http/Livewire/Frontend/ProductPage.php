...
class ProductPage extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.frontend.product-page', ['products' => $products, 'categories' => $categories, 'brands' => $brands, 'popular_products' => $popular_products])->layout('layouts.base');
    }
}
