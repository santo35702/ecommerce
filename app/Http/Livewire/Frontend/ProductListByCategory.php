...
class ProductListByCategory extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.frontend.product-list-by-category', ['products' => $products, 'categories' => $categories, 'brands' => $brands, 'popular_products' => $popular_products, 'category' => $category])->layout('layouts.base');
    }
}
