<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Carousel Update</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Carousel Update</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content pb-2">
      <form class="" action="" method="post" wire:submit.prevent="updateItem">
    <div class="row">
      <div class="col-md-12">
          @if (session('status'))
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
                ...
                @if ($newimage)
                    <img src="{{ $newimage->temporaryUrl() }}" class="img-fluid img-thumbnail rounded mx-auto d-block mt-2" width="180">
                @else
                    <img src="{{ asset('assets/images/slideshow-banners/' . $image) }}" class="img-fluid img-thumbnail rounded mx-auto d-block mt-2" width="180">
                @endif
            </div>
            <div class="form-group">
      ...
      <div class="col-12">
        ...
        <input type="submit" value="Update Carousel" class="btn btn-success float-right">
      </div>
    </div>
    </form>
  </section>
