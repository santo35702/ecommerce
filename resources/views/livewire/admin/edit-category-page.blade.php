<div class="content-wrapper">
  ...
  <section class="content">
      <form class="" action="" method="post" wire:submit.prevent="updateCategory">
    <div class="row">
      <div class="col-md-12">
          @if (session('status'))
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" id="slug" placeholder="Enter Categories Slug" class="form-control" wire:model="slug" disabled>
            </div>
            <div class="form-group">
