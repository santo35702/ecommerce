                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="tabs-listing">
                        <ul class="tabs clearfix">
                            ...
                            @foreach ($new_categories as $key)
                                <li rel="tab{{ $key->id }}" class="">{{ $key->name }}</li> {{-- {{ $key==0 ? 'active' : '' }} --}}
                            @endforeach
                        </ul>
                        <div class="tab_container">
                            ...
                            @foreach ($new_categories as $key)
                                @php
                                    $cat_items = DB::table('products')->where('category_id', $key->id)->get()->take($no_of_products);
                                @endphp
                            <div id="tab{{ $key->id }}" class="tab_content grid-products">
                                <div class="productSlider">
                                    @foreach ($cat_items as $key)
                                        <div class="col-12 item grid-view-item--sold-out">
                                            <!-- start product image -->
                                            <div class="product-image">
                                                <!-- start product image -->
