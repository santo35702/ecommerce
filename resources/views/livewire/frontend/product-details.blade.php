    ...
    <div id="MainContent" class="main-content" role="main">
        ...
        <div class="bredcrumbWrap">
            <div class="container breadcrumbs">
                ...
                <a href="{{ route('home') }}" title="Back to the products page">Products</a>
                <span aria-hidden="true">›</span>
                <span class="text-capitalize">{{ $product->title }}</span>
            </div>
        </div>
        <!--End Breadcrumb-->
                            ...
                            <div class="product-thumb">
                                <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                    <a data-image="{{ asset('assets/images/product-images/' . $product->image ) }}" data-zoom-image="{{ asset('assets/images/product-images/' . $product->image ) }}" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" data-src="{{ asset('assets/images/product-images/' . $product->image ) }}" src="{{ asset('assets/images/product-images/' . $product->image ) }}" alt="" />
                                    </a>
                                    <a data-image="{{ asset('assets/images/product-detail-page/camelia-reversible-big6.jpg') }}" data-zoom-image="{{ asset('assets/images/product-detail-page/camelia-reversible-big6.jpg') }}" class="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" data-src="{{ asset('assets/images/product-detail-page/camelia-reversible1.jpg') }}" src="{{ asset('assets/images/product-detail-page/camelia-reversible1.jpg') }}" alt="" />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product-single__meta">
                                ...
                                <div class="orderMsg" data-user="23" data-time="24">
                                    <img src="{{ asset('assets/images/order-icon.jpg') }}" alt="" /> <strong class="items">5</strong> sold in last <strong class="time">26</strong> hours</div>
                                </div>
                            ...
                            <form method="post" action="#" accept-charset="UTF-8" class="product-form product-form-product-template hidedropdown" enctype="multipart/form-data">
                                ...
                                <div class="product-action clearfix">
                                    <div class="product-form__item--submit mb-2">
                                        <a href="#" class="btn product-form__cart-submit" wire:click.prevent="store({{ $product->id }}, '{{ $product->title }}', {{ $product->regular_price }})">Add To Cart</a>
                                    </div>
