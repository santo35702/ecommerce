                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-thumbnail text-center">
                                        <a href="#"><img src="{{ asset('assets/images/product-images/product-image8.jpg') }}" alt="" title="" /></a>
                                    </td>
                                ...
                                <tr>
                                    <td class="product-remove text-center" valign="middle"><a href="#"><i class="icon icon anm anm-times-l"></i></a></td>
                                    <td class="product-thumbnail text-center">
                                        <a href="#"><img src="{{ asset('assets/images/product-images/product-image4.jpg') }}" alt="" title="" /></a>
                                    </td>
                                ...
                                <tr>
                                    <td class="product-remove text-center" valign="middle"><a href="#"><i class="icon icon anm anm-times-l"></i></a></td>
                                    <td class="product-thumbnail text-center">
                                        <a href="#"><img src="{{ asset('assets/images/product-images/product-image5.jpg') }}" alt="" title="" /></a>
                                    </td>
