                    ...
                    <div class="table-wrapper table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td valign="middle" class="item-row"><img src="{{ asset('assets/images/product-images/product-image16.jpg') }}" alt="" class="featured-image">
                                ...
                                <td class="item-row"><img src="{{ asset('assets/images/product-images/product-image18.jpg') }}" alt="" class="featured-image">
                                <div class="product-price product_price"><span>$89,00</span></div>
                                    <form class="variants clearfix">
                                        <input type="hidden">
                                        <button title="Add to Cart" class="add-to-cart btn btn-solid">Add to Cart</button>
                                ...
                                <td class="item-row"><img src="{{ asset('assets/images/product-images/product-image20.jpg') }}" alt="" class="featured-image">
                                    <div class="product-price product_price"><span>$89,00</span></div>
                                    <form class="variants clearfix">
                                        <input type="hidden">
                                        <button title="Add to Cart" class="add-to-cart btn btn-solid">Add to Cart</button>
                                ...
                                <td class="item-row"><img src="{{ asset('assets/images/product-images/product-image23.jpg') }}" alt="" class="featured-image">
                                    <div class="product-price product_price"><span>$89,00</span></div>
                                    <form class="variants clearfix">
                                        <input type="hidden">
                                        <button title="Add to Cart" class="add-to-cart btn btn-solid">Add to Cart</button>
                                ...
                                <td class="item-row"><img src="{{ asset('assets/images/product-images/product-image28.jpg') }}" alt="" class="featured-image">
                                    <div class="product-price product_price"><span>$89,00</span></div>
                                    <form class="variants clearfix">
                                        <input type="hidden">
                                        <button title="Add to Cart" class="add-to-cart btn btn-solid">Add to Cart</button>
