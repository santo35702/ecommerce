                            ...
                            <tr class="cart__row border-bottom line1 cart-flex border-top">
                                ...
                                <td class="cart__update-wrapper cart-flex-item text-right">
                                    <div class="cart__qty text-center">
                                        <div class="qtyField">
                                            <a class="qtyBtn minus" href="javascript:void(0);" wire:click.prevent="decreaseQuantity('{{ $key->rowId }}')"><i class="icon icon-minus"></i></a>
                                            <input class="cart__qty-input qty" type="text" name="updates[]" id="qty" value="{{ $key->qty }}" pattern="[0-9]*">
                                            <a class="qtyBtn plus" href="javascript:void(0);" wire:click.prevent="increaseQuantity('{{ $key->rowId }}')"><i class="icon icon-plus"></i></a>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center small--hide"><a href="#" class="btn btn--secondary cart__remove" title="Remove tem" wire:click.prevent="removeItem('{{ $key->rowId }}')"><i class="icon icon anm anm-times-l"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2" class="text-right"><a href="#" class="btn--link cart-update" wire:click.prevent="destroyAll()"><i class="fa fa-trash"></i> Remove All</a></td>
                            </tr>
                        </tfoot>
                </table>
            ...
            @else
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                    ...
                    <div class="jumbotron">
                        ...
                        <p class="lead">You have no Items in Cart.</p>
                    </div>
                </div>
            @endif
        </div>
