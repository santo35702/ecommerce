...
<body class="belle @if (request()->routeIs('home'))
    ...
    @elseif (request()->routeIs('products.index') || request()->routeIs('products.list') || request()->routeIs('products.by_category') || request()->routeIs('products.list_category'))
        template-collection
    @elseif (request()->routeIs('products.details'))
        template-product
    @elseif (request()->routeIs('about') || request()->routeIs('contact') || request()->routeIs('cart') || request()->routeIs('login') || request()->routeIs('register')
         || request()->routeIs('compare') || request()->routeIs('checkout') || request()->routeIs('faq') || request()->routeIs('404') || request()->routeIs('wishlist'))
                        ...
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            ...
                            <li class="lvl1 parent dropdown"><a href="#">Pages <i class="anm anm-angle-down-l"></i></a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="{{ route('404') }}" class="site-nav">404</a></li>
                                </ul>
                            </li>
                        ...
                        <div id="header-cart" class="block block-cart">
                            ...
                            @else
                                <ul class="mini-products-list">
                                    ...
                                    <p class="mb-0">Sorry...!! No Products in Cart.</p>
                                    </blockquote>
                                </ul>
                            @endif
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product-single__meta">
                                ...
                                <div class="product-single__description rte">
                                    Bootstrap 4 Logo that will give you and your customers a smooth shopping experience which can be used for various kinds of stores such as fashion,...
                                </div>
      ...
      <div id="popup-window">
        ...
        <div class="display-table splash-bg">
          <div class="display-table-cell width40">
              <img src="{{ asset('assets/images/newsletter-img.jpg') }}" alt="Join Our Mailing List" title="Join Our Mailing List" />
          </div>
